const CACHE='rufe-san-pedro-v6-2-admin-all-text-readable-20260820-1714';
const CORE=[
  './','./index.html','./report.html','./styles.css?v=admin-all-text-readable-20260820-1714','./styles.css','./report-print.css','./app.js','./experience.js','./report-print.js','./map.js',
