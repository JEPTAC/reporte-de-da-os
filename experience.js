...
function storyMeta(index,number){
  const items=[
    ...
    {k:'ENFOQUE DIFERENCIAL',title:'personas en grupos de edad priorizados',text:'La suma de menores de edad y personas de 60 años o más ayuda a orientar medidas de asistencia y acompañamiento.',link:'#poblacion',label:'Ver caracterización →',img:'assets/photos/photo-21.jpg'},
    {k:'CALIDAD DEL DATO',title:'núcleos preenumerados vacíos',text:'Deben confirmarse como filas de plantilla, completarse o excluirse mediante una depuración documentada para evitar sobreestimaciones.',link:'#calidad',label:'Ver qué falta depurar →',img:'assets/photos/photo-22.jpg'}
  ];
